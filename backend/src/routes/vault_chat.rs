...
use crate::handlers::vault_chat::{
    create_chat_message, delete_chat_message, get_message_by_id, get_user_contacts,
    list_chat_messages, update_chat_message,
};
...
pub fn vault_chat_routes() -> Router<VaultChatState> {
    Router::new()
        .route(
            "/chats/:sender_id/:receiver_id/messages",
        ...
        .route("/contacts/:id", get(get_user_contacts))
}
